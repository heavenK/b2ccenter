...
var qqwidth = $("#main").width()==1000?($("#main").offset().left-14):($("#main").offset().left-24); //parseInt(qqclient_width - qqcontent_width) / 2 - 13;
...
qqindex++;
	...
	$(".qq_service").animate({ top:qq_top ,right:$("#main").width()==1000?($("#main").offset().left-14):($("#main").offset().left-24)  }, 0);
});
})
 }
 //#endregion
